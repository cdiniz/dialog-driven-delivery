...
### d3:create-spec
1. Loads user spec templates feature-product-spec and feature-tech-spec from .github/copilot-instructions.md config or this skill
...
### d3:decompose
1. Loads user story template from .github/copilot-instructions.md config or this skill
2. Creates stories following template structure
3. Ensures consistent Given-When-Then acceptance criteria format

### d3:create-adr
1. Loads ADR template from .github/copilot-instructions.md config or this skill
...
1. Loads meeting transcript template from .github/copilot-instructions.md config or this skill
...
```
1. Read .github/copilot-instructions.md for D3 Configuration section
