...
This skill reads configuration from AGENTS.md in the current working directory.
...
**Important:** All operations read this configuration at runtime. If AGENTS.md is not found or doesn't contain the configuration section, defaults are used
