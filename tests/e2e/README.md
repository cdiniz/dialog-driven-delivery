...
1. **Plugin isolation** — the plugin (`.claude-plugin/plugin.json` + `skills/`) is assembled into `tests/e2e/.workspaces/plugin-fixtures/<worker>/d3/` with template files swapped for simplified e2e versions
