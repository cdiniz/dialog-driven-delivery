...
|----------------|-------------------------------|------------------------------------------------------------------|
| Product Specs  | Confluence space PROJ         | Use mcp__atlassian tool to create pages under parent 12345       |
| Tech Specs     | Confluence space PROJ         | Use mcp__atlassian tool to create pages under parent 12345       |
