...
2. Use search to find existing stories in that directory to determine next ID
...
4. **Transform generic template to markdown format:**
   ...
   **Key responsibilities:**
   ...
   - **Body structure:** From template (configurable via .github/copilot-instructions.md)
...
**Implementation:**
1. Use search to find story files by ID
...
- Use search to find stories: `stories/**/story-*.md`
- Use search to search by status, labels, dependencies
...
- **search:** Find story files
- **search:** Search by status, labels, dependencies
