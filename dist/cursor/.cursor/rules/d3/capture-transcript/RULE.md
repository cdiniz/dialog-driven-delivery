...
- If no Transcript Provider configured, guide user to add one to .cursor/rules/d3-config/RULE.md:
  ```markdown
  ### Transcript Provider
...
| Issue | Action |
|-------|--------|
| No provider configured | Guide user to add Transcript Provider to .cursor/rules/d3-config/RULE.md |
