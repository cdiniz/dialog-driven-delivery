...
**Implementation:**
Use Glob to find subdirectories in transcripts/ (typically YYYY-MM directories), or return root location.
...
6. Generate YAML frontmatter:
   ...
   ---
   ```
7. Write frontmatter + body to file using Write tool
8. Return metadata
...
1. Find file using Read tool:
   ...
   - Use Glob pattern `transcripts/**/*{transcript_id}*.md` as fallback
2. Read file content
...
**Implementation:**
1. Use Glob to find all markdown files: `transcripts/**/*.md`
...
**Implementation:**
1. Use Grep to search markdown files in transcripts/ for the query
